...
2. Apply the 12 fact-check corrections in `handoff/factcheck-B.md`, and decide on the 14 unfootnoted statements it lists.
...
- Don't put `[skip netlify]` in the final merge (see HANDOFF section 7).
